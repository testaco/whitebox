...
LINUX_CORTEXM_URL="http://radio.testa.co/bin/linux-M2S-1.12.0.tar.bz2"
...
echo "    $ echo 'PATH=\"`pwd`/linux-cortexm-1.12.0/tools/bin:`pwd`/linux-cortexm-1.12.0/tools/arm-2010q1/bin:\$PATH\"' >> ~/.profile"
